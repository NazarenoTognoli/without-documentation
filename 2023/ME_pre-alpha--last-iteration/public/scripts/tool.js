...
if (localStorage.getItem("sideValues") === null) {
	for (let i = 0; i < 6; i++) {
		let obj = {};
		switch (i) {
		case 0 : localStorage.setItem("sideValues", JSON.stringify(obj));
			break;
		case 1 : localStorage.setItem("techValues", JSON.stringify(obj));
			break;
		case 2 : localStorage.setItem("swtValues", JSON.stringify(obj));
			break;
		case 3 : localStorage.setItem("subTechValues", JSON.stringify(obj));
			break;
		case 4 : localStorage.setItem("linkValues", JSON.stringify(obj));
			break;
		case 5 : localStorage.setItem("rlmValues", JSON.stringify(obj));
			break;
		}
	}
}
