...
document.addEventListener("keydown", function(event) {
	if (event.key === "Enter") {
		...
		if (sideConsoleValue.length === 2  &&
			...
			localStorage.getItem(sideConsoleValue[1]) === null) {
...
document.addEventListener("keydown", function(event) {
	if (event.key === "Enter") {
		...
		if (techConsoleValue.length === 2 && 
		 	...
		 	existe0 === true &&
		 	localStorage.getItem(techConsoleValue[1]) === null){
...
document.addEventListener("keydown", function(event) {
	if (event.key === "Enter") {
		...
		if (swtConsoleValue.length === 2 &&  
			...
			localStorage.getItem(swtConsoleValue[1]) === null) {
...
document.addEventListener("keydown", function(event) {
	if (event.key === "Enter") {
		...
		if (subTechConsoleValue.length === 2 &&  
			...
			existe0 === true &&
			localStorage.getItem(subTechConsoleValue[1]) === null) {
